...
public class TelaCadastro extends JPanel {
	...
	private final JLabel txtTelaCad = new JLabel("Cadastrar contatos");
	...
	private final JTextArea txtrBemvindoAoCadastro = new JTextArea();
	...
	private void initComponents() {
		...
		txtrBemvindoAoCadastro.setWrapStyleWord(true);
		txtrBemvindoAoCadastro.setForeground(Color.WHITE);
		txtrBemvindoAoCadastro.setFont(new Font("Segoe UI", Font.PLAIN, 12));
		txtrBemvindoAoCadastro.setOpaque(false);
		txtrBemvindoAoCadastro.setEditable(false);
		txtrBemvindoAoCadastro.setLineWrap(true);
		txtrBemvindoAoCadastro.setText("Bem-vindo ao cadastro de contatos! Aqui, você pode adicionar novos contatos preenchendo os campos obrigatórios de nome, e-mail, telefone e tipo de contato.");
		
		panel.add(txtrBemvindoAoCadastro, "cell 1 3 3 1,growx,aligny center");
		this.txtNome.setFont(new Font("Segoe UI", Font.BOLD, 12));
		this.txtNome.setForeground(Color.WHITE);
		this.panel.add(this.txtNome, "cell 1 5,alignx right,aligny center");
		this.panel.add(this.edit_nomeCad, "cell 2 5 2 1,growx,aligny center");
		this.txtEmail.setForeground(Color.WHITE);
		this.txtEmail.setFont(new Font("Segoe UI", Font.BOLD, 12));
		this.panel.add(this.txtEmail, "cell 1 6,alignx right,aligny center");
		this.panel.add(this.edit_emailCad, "cell 2 6 2 1,growx");
		this.txtCell.setForeground(Color.WHITE);
		this.txtCell.setFont(new Font("Segoe UI", Font.BOLD, 12));
		this.panel.add(this.txtCell, "cell 1 7,alignx right,aligny center");
		this.panel.add(this.edit_cellCad, "cell 2 7 2 1,growx");
		this.txtTipo.setForeground(Color.WHITE);
		this.txtTipo.setFont(new Font("Segoe UI", Font.BOLD, 12));
		this.panel.add(this.txtTipo, "cell 1 8,alignx right,aligny center");
		...
		this.panel.add(this.rdbtn_pessoal, "flowx,cell 2 8");
		...
		this.panel.add(this.btnVoltar, "flowx,cell 2 10,alignx right,aligny center");
		...
		this.panel.add(this.rdbtn_profissional, "cell 2 8");
		...
		this.panel.add(this.btnCadastrar, "cell 3 10,alignx right,aligny center");
	}
